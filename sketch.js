...
let rotation_radius = 50;
let ellipse_radius = 30;
...
function draw() {
  ...
  if (markerHiro.isVisible() == true) {
    ...
    var x_pos_1 = hPos.x + rotation_radius * cos(frameCount);
    var y_pos_1 = hPos.y + rotation_radius * sin(frameCount);

    var x_pos_2 = hPos.x + rotation_radius * cos(frameCount + 90);
    var y_pos_2 = hPos.y + rotation_radius * sin(frameCount + 90);

    var x_pos_3 = hPos.x + rotation_radius * cos(frameCount + 180);
    var y_pos_3 = hPos.y + rotation_radius * sin(frameCount + 180);
    
    var x_pos_4 = hPos.x + rotation_radius * cos(frameCount - 90);
    var y_pos_4 = hPos.y + rotation_radius * sin(frameCount - 90);

    fill("red");
    ellipse( x_pos_1, y_pos_1, ellipse_radius );
    fill("green");
    ellipse( x_pos_2, y_pos_2, ellipse_radius );
    fill("blue");
    ellipse( x_pos_3, y_pos_3, ellipse_radius );
    fill("yellow")
    ellipse( x_pos_4, y_pos_4, ellipse_radius );
  }
